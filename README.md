...
**[Awesome books]** project adds/removes books to the list.<br />
...
- Choose a directory
- Open a Terminal
- write: git clone git@github.com:zhorabay/Awesome-books-2.git
- get into to directory "Awesome-books-2"
- write: npm install
[
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
Feel free to check the [issues page](https://github.com/zhorabay/Awesome-books-2/issues/2)
